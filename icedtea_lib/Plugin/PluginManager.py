...
from icedtea_lib.Plugin.PluginBase import PluginTypes, PluginBase, RunPluginBase
...
class PluginManager(object): # pylint: disable=too-many-instance-attributes
    ...
    The contents of this dict are registered to relevant parts of IcedTea
    ...
    def register_run_plugins(self, plugin_name, plugin_class):
        """
        Loads a plugin as a dictionary and attaches needed parts to correct IcedTea run
        global parts.
    ...
    def load_default_tc_plugins(self):
        """
        Load default test case level plugins from icedtea_lib.Plugin.plugins.default_plugins
        :return: Nothing
        """
    ...
    def load_default_run_plugins(self):
        """
        Load default run level plugins from icedtea_lib.Plugin.plugins.default_plugins
        :return: Nothing
        """
        for plugin_name, plugin_class in default_plugins.items():
