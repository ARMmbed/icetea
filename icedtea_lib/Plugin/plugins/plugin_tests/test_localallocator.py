...
from icedtea_lib.Plugin.plugins.LocalAllocator import LocalAllocator, init_hardware_dut
from icedtea_lib.Plugin.plugins.LocalAllocator import init_process_dut
...
@mock.patch("icedtea_lib.Plugin.plugins.LocalAllocator.DutDetection", create=False)
@mock.patch("icedtea_lib.Plugin.plugins.LocalAllocator.get_resourceprovider_logger", create=True)
class TestVerify(unittest.TestCase):
    ...
    @mock.patch("icedtea_lib.Plugin.plugins.LocalAllocator.DutConsole")
    ...
    @mock.patch("icedtea_lib.Plugin.plugins.LocalAllocator.DutSerial")
