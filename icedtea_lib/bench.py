...
from icedtea_lib.arguments import get_parser
from icedtea_lib.arguments import get_base_arguments
from icedtea_lib.arguments import get_tc_arguments
from icedtea_lib.build import Build

from icedtea_lib.GenericProcess import GenericProcess
from icedtea_lib.GitTool import get_git_info
...
from icedtea_lib.TestStepError import InconclusiveError
from icedtea_lib.tools.tools import loadClass
...
class Bench(object):
    ...
    def __read_exec_configs(self):
        ...
        #TODO: this bit is not compatible with IcedTeaManager's --tc argument.
    ...
    def __ext_class_loader(self, name, class_type="ExtApps"): #pylint: disable=no-self-use
        """
        Load a module from icedtea_lib.class_type.name
        :param name: name of module
        :param class_type: Name of module in which the loaded module is under icedtea_lib
        :return: class object or None.
        """
        name = "icedtea_lib."+class_type+"." + name
