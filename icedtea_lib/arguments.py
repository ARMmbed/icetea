...
Arguments.py contains the cli argument parser configuration for IcedTea.
"""
...
def get_base_arguments(parser):
    """
    Append base arguments icedtea run arguments to parser
    ...
    parser.add_argument('--failure_return_value',
                        default=False,
                        action="store_true",
                        help='Sets IcedTea to return a failing code to caller if '
