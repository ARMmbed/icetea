...
Framework itself manage Test Bench with given parameters
( Bench.__init__(...) ). With those parameters,
user can manage all TC related and required details,
like what is TC name, status and type, what is purpose,
how many devices it needs etc.
Some of those details are just for test automation and so on not yet used,
but are already reserved keywords..
...
If function fails it raises TestStepError or TestStepFail exception
and start doing ramp down phases and finally end
