...
#
# $ python icetea.py --tcdir examples/multiple_test_cases_by_file_example --list
# TCs:
# +-------+------------------------------+---------+------------+---------+-------+-----------+
...
#
# $ python icetea.py --tcdir examples/multiple_test_cases_by_file_example --tc all
...
#   File "C:\Work\me\tests\icetea\icetea_lib\bench.py", line 1154, in run
#     self.case()
#   File "C:\Work\me\tests\icetea\examples\multiple_test_cases_by_file_example
# \multiple_tests_cases.py
# ", line 109, in multipleTests_SecondTestCase
...
# 09:29:10.780|TC     MainThread: TC Name: C:\Work\me\tests\icetea\icetea_lib\bench.py
