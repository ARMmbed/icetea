...
class TestVerify(unittest.TestCase):
    ...
    def test_resps(self):
        ...
        response.lines = [
            ...
            'oopeli',
            'huhheli' ]
        self.assertTrue(response.verifyMessage(['oopeli'],              False))
        self.assertTrue(response.verifyMessage(['oopeli', 'huhheli'],   False))
        self.assertFalse(response.verifyMessage(['huhheli', 'oopeli'],  False))

        with self.assertRaises(LookupError):
            self.assertTrue(response.verifyMessage(['oop eli']))
