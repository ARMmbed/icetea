...
class APITestCase(unittest.TestCase):
    ...
    def test_get(self, mock_requests_get):
        ...
        self.http = HttpApi(self.host)
        path = "/test"
        mock_requests_get.side_effect = iter([MockedRequestsResponse(), RequestException("Exception raised correctly"),
    ...
    def test_post(self, mock_requests_post):
        ...
        mock_requests_post.side_effect = iter([MockedRequestsResponse(), RequestException("Exception raised correctly"),
                                          MockedRequestsResponse(404), MockedRequestsResponse(200),
                                          MockedRequestsResponse(201)])
        ...
        path2 = "v2/"
        resp = self.http.post(path2, json=json)
        self.assertTrue(mock_requests_post.called, "Failed to call requests.post")
    ...
    def test_put(self, mock_requests_put):
        ...
        mock_requests_put.side_effect = iter([MockedRequestsResponse(), RequestException("Exception raised correctly"),
                                          MockedRequestsResponse(404), MockedRequestsResponse(200),
                                          MockedRequestsResponse(201)])
        ...
        path2 = "v2/"
        resp = self.http.put(path2, data=data)
        self.assertTrue(mock_requests_put.called, "Failed to call requests.put")
    ...
    def test_patch(self, mock_requests_patch):
        ...
        path = "/test"
        data = {"testkey1": "testvalue1"}
        mock_requests_patch.side_effect = iter([MockedRequestsResponse(), RequestException("Exception raised correctly"),
                                         MockedRequestsResponse(404), MockedRequestsResponse(200),
                                         MockedRequestsResponse(201)])
        resp = self.http.patch(path, data=data)
        ...
        path2 = "v2/"
        resp = self.http.patch(path2, data=data)
        self.assertTrue(mock_requests_patch.called, "Failed to call requests.patch")
    ...
    def test_delete(self, mock_requests_delete):
        ...
        self.http = HttpApi(self.host)
        path = "/test"
        mock_requests_delete.side_effect = iter([MockedRequestsResponse(), RequestException("Exception raised correctly"),
                                          MockedRequestsResponse(404), MockedRequestsResponse(200),
