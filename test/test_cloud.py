...
class CloudTestcase(unittest.TestCase):
    ...
    def test_module_import(self):
        ...
        self.assertIsNotNone(cm._client, "Cloud client was None!")
    ...
    def test_updateTestcase(self):
        ...
        self.cloudclient._client.update_testcase.assert_called_once_with({"test": "meta", "meta": "data"})
    ...
    def test_cloudresult_simple(self):
        ...
        self.assertDictContainsSubset(s, res)
